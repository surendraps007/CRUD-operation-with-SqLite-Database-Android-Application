...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean insertData(String name,String email,String courseCount) {
        ...
        SQLiteDatabase db = this.getWritableDatabase();// the permisssion to write in databsse
    ...
    public boolean updateData(String id,String name,String email,String courseCount) {
        ...
        sq.update(TABLE_NAME,contentValues,"ID=?",new String[]{id});
        return true;
    }
    ...
    public Integer deleteData(String id){
        ...
        return db.delete(TABLE_NAME,"ID=id",new String[]{id});
    }
